...
mod libolm {
    ...
    impl Encode for Pickle {
        fn encode(
            ...
            ret += self.next_one_time_key_id.encode(writer)?;
    ...
    impl Decode for Pickle {
        fn decode(
            ...
            let next_one_time_key_id = u32::decode(reader)?;
    ...
    impl From<&Account> for Pickle {
        fn from(account: &Account) -> Self {
            ...
            let next_one_time_key_id = account.one_time_keys.key_id.try_into().unwrap_or_default();
